...
setwd("/Users/sarabcidf/Desktop/ASDS/Text/QTA_Spring23/tutorials/tutorial02/code")
saveRDS(dat, "df2024")

# Checking that the saving works: 
dattry <- readRDS("/Users/sarabcidf/Desktop/ASDS/Text/QTA_Spring23/tutorials/tutorial02/code/df2024")
